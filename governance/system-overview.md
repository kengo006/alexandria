...
> Terms: **role** = independently summonable skill (five of them); **mode** = a method folded *inside* a role (not a separate skill — this prevents trigger proliferation); **iron rule** = single-sourced, referenced everywhere, copied nowhere.
...
| **Researcher** | idea → writing plan (upstream) | "I want to write about…", "how should this be structured?" |
